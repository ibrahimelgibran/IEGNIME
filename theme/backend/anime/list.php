					...
					<div class="row">
						<div class="col-12 col-lg-3 col-xl-3 col-md-4">
							<div class="card shadow-lg">
								<div class="px-2 pt-1 fw-bold"><span class="text-primary">+62 858-7607-6005</span> <small> ~El Gibran</small></div>
								<img class="card-img rounded p-1" src="http://localhost/elgibran/public/storage//default.jpg">
