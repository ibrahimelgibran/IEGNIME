...
<head>
	...
	<!-- App favicon -->
	<link rel="shortcut icon" href="<?= _backEnd() ?>images/ieg.png">
	...
	<div class="wrapper">
		...
		<div class="leftside-menu">
			...
			<a href="#" class="logo text-center logo-light">
				<span class="logo-lg">
					<img src="<?= _backEnd() ?>images/iegcode.png" alt="" height="50">
				</span>
				<span class="logo-sm">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6">
							...
							</script> © AdminPanel by <a href="https://iegcode.my.id">iegcode</a>
						</div>
					</div>
				</div>
			</footer>
